...
var ApplicationLogger = /** @class */ (function () {
    ...
    ApplicationLogger.prototype.init = function (initValues, partnerUserId) {
    ...
    ApplicationLogger.prototype.emitEventLogs = function (loglevel, data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                //  console.log(data, loglevel);
                return [2 /*return*/, this.publishDatatoServer(loglevel, data)];
            });
        });
    };
    ApplicationLogger.prototype.publishDatatoServer = function (loglevel, data) {
        var postObject = { data: data };
        var header = {
            "Content-Type": "application/json"
        };
        axios_1.default.post(this.URL, postObject)
